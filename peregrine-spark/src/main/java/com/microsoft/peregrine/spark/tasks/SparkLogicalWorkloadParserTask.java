...
import com.microsoft.peregrine.spark.planir.enumerators.SparkLogicalViewEnumerator;
import com.microsoft.peregrine.spark.planir.parsers.SparkWorkloadParser;

public class SparkLogicalWorkloadParserTask extends WorkloadParserTask {
  ...
  protected IEnumerator getEnumerator(Workload workload) {
    return (IEnumerator)new SparkLogicalViewEnumerator(workload);
  }
}
